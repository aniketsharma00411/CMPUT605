# -*- coding: utf-8 -*-
"""selective_reinitialization_unlearning_mnist_3(95)_fraction_retraining.ipynb
...
for i in range(0, len(testdata)):
    if testdata[i][1] == 3 and random.random() <= 0.95:
        indices_forget.append(i)
    else:
        indices_retain.append(i)
...
with open("/home/aniket7/unlearning_exps/selective_reinitialization_unlearning_mnist_395_fraction_retraining/selective_reinitialization_unlearning_mnist_395_fraction_retraining.json", "w") as f:
